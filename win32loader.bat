...
::powershell.exe -Command "(gc C:\win32-loader\grub.cfg) -replace 'hostname=debian', 'hostname=%param_hostname%' | Out-File -encoding ASCII C:\win32-loader\grub.cfg"
call:FindReplace "hostname=debian" "hostname=!param_hostname!" C:\win32-loader\grub.cfg
